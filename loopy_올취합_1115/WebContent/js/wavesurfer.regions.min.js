            ...
            var a = function () {
                ...
                return s(n, [{
                    ...
                    key: "render", value: function () {
                        ...
                        for (var t in e.className = "wavesurfer-region", e.title = this.formatTime(this.start, this.end), e.setAttribute("data-id", this.id), this.attributes) e.setAttribute("data-region-" + t, this.attributes[t]);
                        this.wrapper.scrollWidth;
                        if (this.style(e, {position: "absolute", zIndex: 2, height: "100%", top: "0px"}), this.resize) {
                            ...
                            this.style(r, i), this.style(n, i), this.style(n, {left: "100%"})
                        }
                        this.element = this.wrapper.appendChild(e), this.updateRender(), this.bindEvents(e)
                    }
                }, {
                    key: "formatTime", value: function (e, t) {
                    ...
                    key: "updateRender", value: function () {
                        var e = this.wavesurfer.getDuration(), t = this.getWidth();
                        if (this.start < 0 && (this.start = 0, this.end = this.end - this.start), this.end > e && (this.end = e, this.start = e - (this.end - this.start)), null != this.minLength && (this.end = Math.max(this.start + this.minLength, this.end)), null != this.maxLength && (this.end = Math.min(this.start + this.maxLength, this.end)), null != this.element) {
                            var r = Math.round(this.start / e * t), n = Math.round(this.end / e * t) - r;
                                ...
                                if (o = r, y.drag && l && (w = w || !!n, y.onDrag(n)), y.resize && h && (w = w || !!n, y.onResize(n, h)), y.scroll && v.clientWidth < y.wrapper.scrollWidth) {
                                    ...
                                    c && function e(t) {
                                        if (c && (l || h)) {
                                            ...
                                            var n = y.wavesurfer.drawer.handleEvent(t) * p, i = n - o;
                    ...
                    key: "onResize", value: function (e, t) {
                        "start" == t ? this.update({
                ...
                return s(n, null, [{
                    ...
                    key: "add", value: function (e) {
                        var t = this, r = new this.wavesurfer.Region(e, this.wavesurfer);
                    ...
                    key: "enableDragSelection", value: function (n) {
                        var i, s, a, o, u, l, d, h = this, c = n.slop || 2, f = this.wavesurfer.drawer.container,
                            v = !1 !== n.scroll && this.wavesurfer.params.scrollParent, p = n.scrollSpeed || 1,
                            m = n.scrollThreshold || 10, g = this.wavesurfer.getDuration(), w = 0, e = function (e) {
                    ...
                    key: "disableDragSelection", value: function () {
                        this.fireEvent("disable-drag-selection")
                    }
                }, {
                    key: "getCurrentRegion", value: function () {
                        var r = this, n = this.wavesurfer.getCurrentTime(), i = null;
