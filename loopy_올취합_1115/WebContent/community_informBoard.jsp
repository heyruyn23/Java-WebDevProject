...
<%
	...
	List<Text> list = TextsDAO.selectIList(pageVO);
	
	int total = TextsDAO.selectITotal();	
...
<div id="communityTap">
    ...
    <div class="informBoard on"><a href="community_informBoard.jsp">정보 게시판</a></div>
...
<div class="boardListContents">
    ...
    <div class="communityTitle">정보게시판</div>
