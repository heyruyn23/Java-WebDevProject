...
<div class="mainPopup"></div><!--팝업 배경 불투명-->
    ...
    <div id="addWorkBoxPopup">
        <div class="addBoxName"><span class="addCheckBoxName"><span>앨범</span></span><button class="outBtn"><i class="fas fa-times"></i></button></div>
            <ul id="addContents">
            <%--
            <%for(Playlist playlist : alist ) {
			...
			List<String> blkTags = BLKTagDAO.selectList(blkTag);
               ...
               <div><span><%=playlist.getName() %></span></div>
...
<div id="makeWorkBoxPopup">
	<form  method="get"  id="makeWorkBoxPopupForm"
             action="/ajax/insertPlayList.jsp">
    <div class="checkBox"><span class="checkBoxName">새 앨범 만들기</span>
    <button class="outBtn1" type="button"><i class="fas fa-times"></i></button></div>
 ...
 */
        ...
        var albumTmp = _.template($("#albumTmp").html());
        ...
        function getAlbumList() {
        	...
        	$.ajax({
        		...
        		dataType:"json",
        		type:"get",
        		data:{acType:"album",userNo:1},//나중에 표현식으로(loginUser의 번호)
        		error:function() {
        			alert("에러");
        		},
        		success:function(json) {
        			$("#addContents").html(albumTmp({albums:json}));
        		}
        	});
...
$("#makeWorkBoxPopupForm").submit(function() {
