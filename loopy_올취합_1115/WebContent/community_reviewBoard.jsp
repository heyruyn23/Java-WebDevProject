...
<%
	...
	List<Text> list = TextsDAO.selectRList(pageVO);
	
	int total = TextsDAO.selectRTotal();	
...
<div id="communityTap">
    ...
    <div class="reviewBoard on"><a href="community_reviewBoard.jsp">리뷰 게시판</a></div>
...
<div class="boardListContents">
    ...
    <div class="communityTitle">리뷰게시판</div>
