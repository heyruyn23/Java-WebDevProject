...
<%
	...
	List<Text> list = TextsDAO.selectQList(pageVO);
	
	int total = TextsDAO.selectQTotal();	
...
<div id="communityTap">
    ...
    <div class="queryBoard on"><a href="community_queryBoard.jsp">질문 게시판</a></div>
...
<div class="boardListContents">
    ...
    <div class="communityTitle">질문게시판</div>
