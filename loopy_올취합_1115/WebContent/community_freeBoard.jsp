...
<%
	...
	List<Text> list = TextsDAO.selectFList(pageVO);
	
	int total = TextsDAO.selectFTotal();	
...
<div id="communityTap">
    ...
    <div class="freeBoard on"><a href="community_freeBoard.jsp">자유 게시판</a></div>
    ...
    <div class="informationBoard"><a href="community_informationBoard.jsp">정보 게시판</a></div>
...
<div class="boardListContents">
    ...
    <div class="communityTitle">자유게시판</div>
