...
<%
	...
	List<Text> list = TextsDAO.selectPList(pageVO);
	
	int total = TextsDAO.selectPTotal();	
...
<div id="communityTap">
    ...
    <div class="PRBoard on"><a href="community_PRBoard.jsp">홍보 게시판</a></div>
...
<div class="boardListContents">
    ...
    <div class="communityTitle">홍보게시판</div>
